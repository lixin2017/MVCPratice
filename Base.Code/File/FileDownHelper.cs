        ...
        public static void DownLoadold(string FileName, string name)
        {
            ...
            if (File.Exists(destFileName))
            {
                ...
                HttpContext.Current.Response.AppendHeader("Content-Disposition", 
                    "attachment;filename=" + HttpUtility.UrlDecode(name, System.Text.Encoding.UTF8));
        ...
        public static void DownLoad(string FileName)
        {
            ...
            try
            {
                ...
                HttpContext.Current.Response.AddHeader("Content-Disposition",
                    "attachment;filename=" + HttpUtility.UrlDecode(filePath, System.Text.Encoding.UTF8));
            ...
            try
            {
                ...
                try
                {
                    ...
                    _Response.AddHeader("Content-Disposition",
                        "attachment;filename=" + HttpUtility.UrlDecode(_filename, System.Text.Encoding.UTF8));
